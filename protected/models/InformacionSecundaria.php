...
/**
 * Esta es la clase modelo para la tabla "{{informacion_secundaria}}".
 *
 * Las siguientes son las columnas de la tabla '{{informacion_secundaria}}':
 * @property integer $id
 * @property string $que
 ...
 */
class InformacionSecundaria extends CActiveRecord
{
        /**
	 ...
	 * @return InformacionSecundaria the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('que, a_quien, como, descripcion', 'required'),
			array('que, a_quien, como', 'length', 'max'=>128),
                        array('descripcion', 'length', 'max'=>512),
			array('created_at, updated_at, proceso_id', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, que, a_quien, como, descripcion, proceso_id, created_at, updated_at', 'safe', 'on'=>'search'),
	...
	public function search()
	{
		...
		$criteria->compare('a_quien',$this->a_quien,true);
