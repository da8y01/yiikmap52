...
/**
 * Esta es la clase modelo para la tabla "{{documentacion}}".
 *
 * Las siguientes son las columnas de la tabla '{{documentacion}}':
 * @property integer $id
...
{
        /**
         * @var integer documentacion ID
         * @soap
         */
        public $id_soap;

        /**
         * @var string documentacion nombre
         * @soap
         */
        public $nombre_soap;

        /**
         * @var string documentacion locacion
         * @soap
         */
        public $locacion_soap;

        /**
         * @var integer documentacion proceso_id
         * @soap
         */
        public $proceso_id_soap;

        /**
         * @var string documentacion descripcion
         * @soap
         */
        public $descripcion_soap;

        /**
         * @var string documentacion created_at
         * @soap
         */
        public $created_at_soap;

        /**
         * @var string documentacion updated_at
         * @soap
         */
