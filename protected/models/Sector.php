 ...
 *
 * Las siguientes son las columnas de la tabla '{{sector}}':
 * @property integer $id
 ...
 * @property Organizacion[] $organizaciones
 */
class Sector extends ModelBase
{
        /**
         * @var integer sector ID
         * @soap
         */
        public $id_soap;

        /**
         * @var string sector nombre
         * @soap
         */
        public $nombre_soap;

        /**
         * @var string sector descripcion
         * @soap
         */
        public $descripcion_soap;

        /**
         * @var string sector created_at
         * @soap
         */
        public $created_at_soap;

        /**
         * @var string sector updated_at
         * @soap
         */
	...
	public function relations()
	{
		...
		return array(
			'organizaciones' => array(self::HAS_MANY, 'Organizacion', 'sector_id'),
		);
	}
	...
	public function search()
	{
        ...
        public function afterSave() {
            ...
            $sQuery = '
                uc_secs:Sector-'.$this->id.' 
                    a uc_classdefs:ClassSector ; 
        ...
        public function afterDelete() {
            ...
            $sQuery = 'uc_secs:Sector-'.$this->id.' ?p ?o .';
