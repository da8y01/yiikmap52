...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'capital-humano-has-intangible-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'intangible_id'); ?>
                <?php echo $form->dropDownList($model, 'intangible_id',
                        CHtml::listData(Intangible::model()->findAll(), 'id', 'nombre', 'tiponombre'),
                        array('prompt'=>'Seleccionar...', 'empty'=>'Sin elementos')
                ); ?>
		<?php echo $form->error($model,'intangible_id'); ?>
	</div>
