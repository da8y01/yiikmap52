...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'informacion-secundaria-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'a_quien'); ?>
		<?php echo $form->textField($model,'a_quien',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'a_quien'); ?>
	</div>
