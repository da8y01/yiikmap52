...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'proceso-has-capital-relacional-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'capital_relacional_id'); ?>
                <?php echo $form->dropDownList($model, 'capital_relacional_id',
                        CHtml::listData(CapitalRelacional::model()->findAll(), 'id', 'orgnombre', 'orgsector'),
                        array('prompt'=>'Seleccionar...', 'empty'=>'Sin elementos')
                    );
                ?>
		<?php echo $form->error($model,'capital_relacional_id'); ?>
	</div>
