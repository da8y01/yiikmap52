...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('proceso-has-capital-relacional-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Gestionar Procesos tienen Capitales Relacionales</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'proceso-has-capital-relacional-grid',
