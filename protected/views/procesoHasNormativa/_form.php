...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'normativa_id'); ?>
                <?php echo $form->dropDownList($model, 'normativa_id',
                        CHtml::listData(Normativa::model()->findAll(), 'id', 'nombre'),
                        array('prompt'=>'Seleccionar...', 'empty'=>'Sin elementos')
                    );
                ?>
		<?php echo $form->error($model,'normativa_id'); ?>
	</div>
